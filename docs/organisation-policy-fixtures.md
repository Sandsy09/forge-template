...
`scientific-python`, and -- since FT-17.02 -- the `github` platform)
deliberately provides only a small capability set. Most scenarios therefore
resolve against the fixture catalogue
