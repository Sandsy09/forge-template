...
has no release or publish workflow to attach either to. Stage 06 now supplies
the required composition mechanics, but implementation stays deferred until
the contract's remaining exit criteria hold.
